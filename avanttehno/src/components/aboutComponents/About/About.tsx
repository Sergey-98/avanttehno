    ...
    <section className={styles.about__company_wrapper}>
      <div className={styles.about__company_textwrapper}>
        ...
        <p className={styles.about__company_text}>
          ...
          является официальным дистрибьютером крупнейшего производителя GOODSENSE, JAC.
        </p>
        <p className={styles.about__company_text}>
        ...
        <p className={styles.about__company_text}>
          ...
          качественное сервисное обслуживание как в гарантийный, так и послегарантийный период.
