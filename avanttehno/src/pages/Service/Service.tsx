      ...
      <div className={classes.service__company_wrapper}>
        <div className={classes.service__company_textwrapper}>
          ...
          <span className={classes.service__company_text}>
            Наша Компания, являясь официальным дилером XGMA, GOODSENSE, JAC, SHANN, и использует в
            работе и предлагает своим клиентам только оригинальные запасные части и рекомендованные
